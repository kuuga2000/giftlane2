...
<div class="container">
    <div class="checkout_bill">
            ...
            <input name="" type="text" class="fieldRow" value="First Name*"/>
            <input name="" type="text" class="fieldRow" value="Last Name*"/>
            <input name="" type="text" class="fieldRow" value="Telephone*"/>
            <input name="" type="text" class="fieldRow" value="Address*"/>
            <input name="" type="text" class="fieldRow" value=""/>
            <label>Country</label>
            <div class="relet">
            ...
            <input name="" type="text" class="fieldRow" value="City Postal Code*"/>
            ...
            <div class="addOutter">
                ...
                <h1>SPECIAL REQUESTS/ ADDITIONAL INFO</h1>
                 <div class="abDiv2">
                    <textarea class="textArea2" rows="" cols="" name="">Type your Message Here...</textarea>
                </div>
              </div>
              </div>
          </div>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="cart_table">
        <thead>
          <tr>
            ...
            <td class="cart_tbl_ttl">EXTARS</td>
        ...
        <tr>
            <td valign="top">
            <a href="#"><strong>Necklace</strong></a><br />
            <small class="cart_brand">Old Faithful Shop</small>
          ...
          <tr>
            ...
            <td valign="top" class="cart_in_brdr_none padding_subtl"><strong>IDR 350 K</strong></td>
          ...
          <tr>
            ...
            <td valign="top" class="cart_in_brdr_none padding_tp_btm5">IDR 600 K</td>
          ...
          <tr>
            ...
            <td valign="top" class="cart_in_brdr_none padding_tp_btm5"><strong>IDR 600 K</strong></td>
            <td align="right" valign="top" class="cart_in_brdr_none padding_tp_btm5">&nbsp;</td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="right" style="float: right; margin-top:40px;"><input type="button" value="COMPLETE CHECKOUT" id="" onclick="" class="comButton"></div>
  </div>


<div style="padding:50px 0; overflow:auto; width:100%;"></div>
