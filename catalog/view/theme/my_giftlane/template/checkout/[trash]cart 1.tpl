				...
				<div class="recipient">
			       ...
			       <div class="srTitle"><div class="SelectRecipient">Select Recipient</div><span>Or, Send It to My Address</span></div>
			            <div class="addNew">
							...
							<input name="[<?php echo $product['product_id']; ?>][addressname]" id="addressname_<?php echo $product['product_id']; ?>" type="text" class="fieldRow" value="" placeholder="Address name*"/> 
							</div>	
							...
							<div id="stateError_<?php echo $product['product_id']; ?>" class="error"></div>
			                  ...
			                  <div class="relet mr15" id="cityColumn_<?php echo $product['product_id']; ?>"><br>
...
function selectWrapping(productId,wrappingId)
{
	...
	$('#giftwrapping_'+productId+' .greetingCard .grLeft').append('<div style="margin:35% 37%;" class="loading">&nbsp;<img src="image/loading_big.gif" alt="" /></div>');
			},
			complete: function() {
			$('.loading').remove();
			},			
