...
<head>
<meta charset="UTF-8" />
<title><?php echo $title,$this->config->get("config_name"); ?></title>
...
$(document).ready(function() {
	...
	$("#closeSrchBox").on("click", function()
	{
    ...
    <div class="search_header">
        ...
        <form name="searchfrm" id="searchfrm" method="POST" action="">
         ...
         onfocus="if (this.value == 'Search') {this.value = '';}">
            ...
            <a name="" id="closeSrchBox" title="Close"><div class="close_search"></div></a>
            </form>
        </div>
    </div>	
</div>
...
<div class="header2">
    ...
    <?php } ?>
	<!--Submen -->
	<?php if($this->request->server['QUERY_STRING'] != 'route=common/home') { ?>
    <div class="subMenu">
        <ul>
        <li><a href="<?php echo $home; ?>">HOME</a></li>
        <li><a href="<?php echo $personalise_link; ?>">PERSONALISE</a></li>
