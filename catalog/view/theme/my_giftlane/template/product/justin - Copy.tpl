		...
		<?php if (count($categories1)) {
        	...
        	<ul class="subCata">
				...
				# echo "<pre>";print_r($categories1); exit;
				 ...
				 <?php  break;}				  
				  $cat_cnt++; } ?>                           
				  <li class="all"><a href="<?php echo $allCategory;?>">All</a></li>
            </ul>
			<?php 	} 
			else
			{
...
function updateSuggestions()
{
	...
	$('.displayBox .productBx #searchDiv_'+page).load('index.php?route=product/justin/ajaxSearch&page='+page+'&limit='+limit+'&path='+path);
