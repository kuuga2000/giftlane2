     ...
     <div id="showcategory" class="displayBox">
            ...
            <div class="productBx">
			 <?php foreach ($allproducts as $product) { ?>
            	<ul>
                	<li><a href="<?php echo $this->url->link('product/product','&product_id=' . $product['product_id']); ?>"><div class="pro_hover"></div>
					<?php //echo $category['thumb']; ?>
					<img width="300" height="450" src="<?php echo $product['image']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
                    	<div class="proDetial">
                        	<div class="proLeft">
                           		<a href="<?php echo $product['name']; ?>"><?php echo $product['name']; ?></a>
                                <span class="brandName"><a href="#"></a></span>
                            </div>
                          <div class="proRight">IDR <?php echo number_format($product['price'],0,'','.'); ?></div>
                        </div>
                    </li>
					 </ul>
					 <?php } ?>
