...
<div class="header2">
  ...
  <div class="product-info">
    ...
    <div class="left_pro">
      <?php if ($thumb) { ?>
      <div class="image"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" />
...
<div id="addCartPopup">
        ...
        <a href="<?php echo $myCart;?>" id="mycart" onclick="" class="comButton" style="margin-top:10px;">CUSTOMIZE WRAPPING</a><a href="<?php echo $myCart;?>" onclick="" class="comButton" style="margin-top:10px;" id="">VIEW YOUR CART</a>
        </div>
		...
		success: function(res) {
			if(res > 0)
			{
				...
				$('#productQuantity').selectbox();
				 $('#button-cart').show();
				 $('.missQuestion_ttl').hide();
			}
			else
			{
				 $('.price').before('<div style="clear:both; margin:30px 0 0px 0;text-align: left" class="missQuestion_ttl">Sorry, this product is out of stock</div>');
				 $('#button-cart').hide();
			}
