  ...
  <!-- start Basic Jquery Slider -->
	...
	<li>
	  ...
	  <?php $cnt++; } ?>
	   ...
	   <!--<div  name="showdiv" id="personaliseStep_1" class="show personalise_Banner displayNone" >
	  <div class="banner_desc">
	  <div class="banner_ttl">Lets Personalise Your Gift.</div>
	  <div class="banner_sub_ttl">Let's us know a bit about this special someone,<br />
              and we'll do the rest for  you.</div>
	   </div>
	    <a href="javascript:void(0)" id="getStartedBtn_<?php echo $cnt; ?>" name="getStartedBtn_<?php echo $cnt; ?>" class="get_start_btn">&nbsp;</a> </div>-->
...
$(window).load(function() {
  $('.flexslider').flexslider({
	...
	before: function(slider){
		...
		//$('.personalise_Banner').addClass('displayNone');
