...
<div class="header" style="width:100% !important;">
		<div class="topNav" style="width:100%;height:55px;background:white;top:0px;line-height:50px">
		<?php if(isset($logged)) { ?>
          <ul>
          <li id="linkink"><a href="<?php echo $account; ?>"><?php echo $firstname.' '.$lastname ?></a></li>
          <li id="linkink"><a href="<?php echo $logout; ?>">LOGOUT</a></li>
          </ul>
		<?php  } else { ?>
		<ul>
		...
		<?php } ?>  
            ...
            <div class="logo" style="z-index:999; position:relative;">
				<div style="background:white">sdf</div>
				<a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" width="389" height="95" alt="" /></a>
			</div>
...
$(window).load(function() {
  ...
  $('.topslider').flexslider({
	...
	start:function(slider){
		...
		//alert(bgUrl);
		$('#intro').css('background','url('+bgUrl+') 50% 55px no-repeat fixed' );
		$('#intro').css('background-size', '100%');//1400px	
