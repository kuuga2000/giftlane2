...
class ModelCatalogManufacturer extends Model {
	...
	public function getManufacturerByProduct($productId) {
		$query = $this->db->query("SELECT name FROM " . DB_PREFIX . "manufacturer m LEFT JOIN " . DB_PREFIX . "product p ON (p.manufacturer_id = m.manufacturer_id) WHERE p.product_id = ".(int)$productId." ");
