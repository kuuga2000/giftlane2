...
class ControllerAccountOrder extends Controller {
	...
	public function index() {
		...
		foreach ($results as $result) {
			...
			$paymentStatus = $this->model_account_order->getOrderPaymentStatusByOrderId($result['order_id']);
			$this->data['orders'][] = array(
	...
	public function info() { 
		...
		$txtOrderStatus = $this->model_account_order->getOrderStatusById($order_info['order_status_id']);
		if ($order_info) {
			...
			$this->data['orderStatus'] = $txtOrderStatus;
			...
			$this->load->model('catalog/manufacturer');
      		foreach ($products as $product) {
				...
				$manufacturer = $this->model_catalog_manufacturer->getManufacturerByProduct($product['product_id']);
			
				$manufaturerName = '';
				if(isset($manufacturer['name']))
				{
					$manufaturerName = $manufacturer['name'];
				}
        		$this->data['products'][] = array(
          			'name'     => $product['name'],
          			'model'    => $product['model'],
