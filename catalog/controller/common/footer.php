...
class ControllerCommonFooter extends Controller {
	protected function index() {
		...
		//Commonj Pages Url
		//$this->data['aboutus'] = $this->url->link('account/login');
		// Whos Online
		...
		if($this->config->get('config_tumbler')!='')	
		{
		$this->data['tumbler']=$this->config->get('config_tumbler');
		}
		else 
		$this->data['tumbler']="#";	
		if($this->config->get('config_pinterest')!='')	
		{
