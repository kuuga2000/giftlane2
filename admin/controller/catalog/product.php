...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	protected function getForm() {
		...
		$this->data['tab_personalize_question'] = 'Personalize Questions';
		$this->data['tab_options_category'] = 'Options Category';
		...
		if (isset($this->request->post['justin']) && $this->request->post['justin'] != '') {
      		$this->data['justin'] = $this->request->post['justin'];
		} elseif (!empty($product_info)) {
			$this->data['justin'] = $product_info['justIn'];
    	} else {
      		$this->data['justin'] = 0;
    	}
		...
		//------------------ Get answers for product
		$this->load->model('catalog/personalize_question');
		$this->data['answers'] = array();
		$this->data['productEvents'] = array();
		$this->data['productReceipients'] = array();
		$this->data['productGender']= array();
		$this->data['personalities'] = array();
		$this->data['interests'] = array();
		if(isset($this->request->get['product_id']))
		{
			$this->data['answers'] = $this->model_catalog_personalize_question->getAnswers($this->request->get['product_id']);
			if(count($this->data['answers']) > 0)
			{
				$this->data['productEvents'] = explode(',',$this->data['answers'][0]['events']);
				$this->data['productReceipients'] = explode(',',$this->data['answers'][0]['receipients']);
				$this->data['productGender'] = explode(',',$this->data['answers'][0]['gender']);
				$this->data['personalities'] = explode(',',$this->data['answers'][0]['personality']);
				$this->data['interests'] = explode(',',$this->data['answers'][0]['interests']);
			}
		...
		/*echo '<pre>';
		print_r($this->data['productGender']);
		echo '</pre>';*/
		//-------------------- Personalize gift Section ---------------------------
		
		
		//-------------------- Getting personalize gift questions ---------------------------
		$this->data['personalize_questions'] = $this->model_catalog_personalize_question->getPersonalizeQuestions();	
		...
		$this->data['option_categories'] = $this->model_catalog_option_category->getOptionCategory($this->request->get['product_id']);
		$this->data['option_categories_color'] = $this->model_catalog_option_category->getOptionAllCategory('color');
		$this->data['option_categories_size'] = $this->model_catalog_option_category->getOptionAllCategory('size');
