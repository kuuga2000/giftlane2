...
class ControllerLocalisationCity extends Controller {
	...
	private function getList() {
    	...
    	foreach ($results as $result) {
			...
			$city_price = $this->model_localisation_city->getPrice($result['city_id']);
			$this->data['cities'][] = array(
				...
				'shippprice'	=> $result['city_country'],
	...
	private function getForm() {
		...
		$strPrice = "";
		$strPrice =  $this->model_localisation_city->getPrice($this->request->get['city_id']);
		if (isset($this->request->post['price'])) {
			$this->data['price'] = $this->request->post['price'];
		} elseif (isset($strPrice)) {
			
			$this->data['price'] = $strPrice;
		} else {
			$this->data['price'] = '';
		}
	...
	private function validateForm() {
		...
		if (($this->request->post['price'] != "") && (!(int)($this->request->post['price']))) 		{
			$this->error['price'] = "Please enter valid price.";
		}
		if (!$this->error) {
	  		return TRUE;
		} else {
