...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_option_category'] = $this->language->get('text_help');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['option_category'] = $this->url->link('catalog/optioncategory/', 'token=' . $this->session->data['token'], 'SSL');
			
			$this->data['option_personlize'] = $this->url->link('catalog/optionpersonalize/', 'token=' . $this->session->data['token'], 'SSL');
