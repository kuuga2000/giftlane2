...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><!--<a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a>--><a href="#tab-image"><?php echo $tab_image; ?></a><!--<a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a>--><a href="#tab_personalize_question"><?php echo $tab_personalize_question; ?></a><a href="#tab_options_category"><?php echo $tab_options_category; ?></a>
	  </div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-links">
          <table class="form">
			...
			<tr>
              <td>Just In</td>
              <td><input type="checkbox" name="justin" id="justin" <?php if(isset($justin) && $justin == 1){ ?> checked="checked" <?php } ?> /></td>
            </tr>
            <tr>
        ...
        <div id="tab-option2" style="display:none;">
		...
		<div id="tab_personalize_question">
			<table class="list">
			<thead>
              <tr>
			...
			<tr>
				<td class="left"><?php echo $personalize_questions[0]['question']; ?></td>
				<td class="left"><select style="width: 170px" name="events[]" size="3" multiple="multiple"><?php foreach($personalize_events AS $personalize_event) {  ?> <option <?php if(in_array($personalize_event['answer'],$productEvents)){?> selected="selected" <?php } ?> value="<?php echo $personalize_event['answer'] ?>"><?php echo $personalize_event['answer']; ?></option> <?php } ?></select></td>
			</tr>
			
			<tr>
				<td class="left"><?php echo $personalize_questions[1]['question']; ?></td>
				<td class="left"><select style="width: 170px" name="receipient[]" size="3" multiple="multiple"><?php foreach($personalize_receipients AS $personalize_receipient) {  ?> <option <?php if(in_array($personalize_receipient['answer'],$productReceipients)){?> selected="selected" <?php } ?> value="<?php echo $personalize_receipient['answer'] ?>"><?php echo $personalize_receipient['answer']; ?></option> <?php } ?></select></td>
			</tr>
			
			<tr>
				<td class="left"><?php echo $personalize_questions[2]['question']; ?></td>
				<td class="left"><select name="personality[]" style="width: 170px" size="3" multiple="multiple"><?php foreach($personalize_personality AS $personality) {  ?> <option <?php if((in_array($personality['answer'],$personalities))){?> selected="selected" <?php } ?> value="<?php echo $personality['answer'] ?>"><?php echo $personality['answer']; ?></option> <?php } ?></select></td>
			</tr>
			<tr>
				<td class="left"><?php echo $personalize_questions[3]['question']; ?></td>
				<td class="left"><select name="gender[]" size="2" style="width: 170px" multiple="multiple" ><option <?php if(in_array('male',$productGender)){?> selected="selected" <?php } ?> value="male">Male</option><option <?php if(in_array('female',$productGender)){?> selected="selected" <?php } ?> value="female">Female</option></select></td>
			</tr>
			<tr>
				<td class="left"><?php echo $personalize_questions[4]['question']; ?></td>
				<td class="left">Start: <select name="startAge"><?php for($ageCount = 1; $ageCount<=100; $ageCount++ ) { ?><option <?php if(isset($answers[0]['min_age']) && $answers[0]['min_age']== $ageCount){?> selected="selected" <?php } ?> value="<?php echo $ageCount ?>"><?php echo $ageCount ?></option> <?php } ?></select>&nbsp;&nbsp;&nbsp;
				End: <select name="endAge"><?php for($ageCount = 1; $ageCount<=100; $ageCount++ ) { ?><option <?php if(isset($answers[0]['max_age']) && $answers[0]['max_age']== $ageCount){?> selected="selected" <?php } ?> value="<?php echo $ageCount ?>"><?php echo $ageCount ?></option> <?php } ?></select></td>
			</tr>
			<tr>
			     
				<td class="left"><?php echo $personalize_questions[5]['question']; ?></td>
				<td class="left"><select name="interest[]" multiple="multiple"  style="width: 170px">
					<?php foreach($personalize_interest AS $interest) {  ?>
						<?php if(in_array($interest['answer'],$interests)){?>
						<option selected="selected" value="<?php echo $interest['answer'] ?>"><?php echo $interest['answer'] ?></option>
						<?php }else{?>
						<option value="<?php echo $interest['answer'] ?>"><?php echo $interest['answer'] ?></option>
						<?php }?>
					<?php } ?>
			...
			<tr>
				<td class="left"><?php echo $personalize_questions[6]['question']; ?></td>
				<td class="left">Start: <select name="startTecksavy"><?php for($techCount = 1; $techCount<=100; $techCount++ ) { ?><option <?php if(isset($answers[0]['min_tech_savvy']) && $answers[0]['min_tech_savvy']==  $techCount){?> selected="selected" <?php } ?> value="<?php echo $techCount ?>"><?php echo $techCount ?></option> <?php } ?></select>&nbsp;&nbsp;&nbsp;
				End: <select name="endTecksavy"><?php for($techCount = 1; $techCount<=100; $techCount++ ) { ?><option <?php if(isset($answers[0]['max_tech_savvy']) && $answers[0]['max_tech_savvy']==  $techCount){?> selected="selected" <?php } ?> value="<?php echo $techCount ?>"><?php echo $techCount ?></option> <?php } ?></select></td>
			</tr>
			<tr>
				<td class="left"><?php echo $personalize_questions[7]['question']; ?></td>
				<td class="left">Start: <select name="startWarddrobColor"><?php for($warddrobColorCount = 1; $warddrobColorCount<=100; $warddrobColorCount++ ) { ?><option <?php if(isset($answers[0]['min_warddrobe_color']) && $answers[0]['min_warddrobe_color'] ==  $warddrobColorCount){?> selected="selected" <?php } ?> value="<?php echo $warddrobColorCount ?>"><?php echo $warddrobColorCount ?></option> <?php } ?></select>&nbsp;&nbsp;&nbsp;
				End: <select name="endWarddrobColor"><?php for($warddrobColorCount = 1; $warddrobColorCount<=100; $warddrobColorCount++ ) { ?><option <?php if(isset($answers[0]['max_warddrobe_color']) && $answers[0]['max_warddrobe_color'] ==  $warddrobColorCount){?> selected="selected" <?php } ?> value="<?php echo $warddrobColorCount ?>"><?php echo $warddrobColorCount ?></option> <?php } ?></select></td>
			</tr>
			<tr>
				<td class="left"><?php echo $personalize_questions[8]['question']; ?></td>
				<td class="left">Start: <select name="startCreativity"><?php for($creativityCount = 1; $creativityCount<=100; $creativityCount++ ) { ?><option <?php if(isset($answers[0]['min_creativity_level']) && $answers[0]['min_creativity_level'] ==  $creativityCount){?> selected="selected" <?php } ?> value="<?php echo $creativityCount ?>"><?php echo $creativityCount ?></option> <?php } ?></select>&nbsp;&nbsp;&nbsp;
				End: <select name="endCreativity"><?php for($creativityCount = 1; $creativityCount<=100; $creativityCount++ ) { ?><option <?php if(isset($answers[0]['max_creativity_level']) && $answers[0]['max_creativity_level'] ==  $creativityCount){?> selected="selected" <?php } ?> value="<?php echo $creativityCount ?>"><?php echo $creativityCount ?></option> <?php } ?></select></td>
			</tr>
			</table>
		</div>
		<div id="tab_options_category">
			<table id="optioncategory" class="list">
				<thead>
	              <tr>
				 ...
				 <?php $optioncategory_row = 0;
				 ?>
            	 <?php foreach ($option_categories as $option_category) {
				 ?>
				 
					<tbody id="optioncategory-row<?php echo $optioncategory_row; ?>">
					 <tr>
                		<td class="left">
							<select style="width: 170px" name="product_option_category[<?php echo $optioncategory_row; ?>][color]" >	 
								
								<option value="">SELECT</option>
								<?php 
								
									foreach($option_categories_color as $intK => $option_categories_colorDtls)
									{
										$strOptionName = $option_categories_colorDtls['name'];
										$strOptionValue = $option_categories_colorDtls['value'];
										$strSelected = "";
										
										if(strtolower($option_category['color']) == strtolower($strOptionValue))
										{
											$strSelected = "selected = 'selected'";
										}
									?>
										<option value="<?PHP echo $strOptionValue; ?>" <?PHP echo $strSelected?>><?PHP echo $strOptionName; ?></option>
								<?php }	?>
								
								<!--<option value="red" <?PHP if($option_category['color'] == "red"){ echo "selected = 'selected'"; } ?>>RED</option>
								<option value="blue" <?PHP if($option_category['color'] == "blue"){ echo "selected = 'selected'"; } ?>>BLUE</option>
								<option value="yellow" <?PHP if($option_category['color'] == "yellow"){ echo "selected = 'selected'"; } ?>>Yellow</option>
								<option value="white" <?PHP if($option_category['color'] == "white"){ echo "selected = 'selected'"; } ?>>White</option>
								<option value="orange" <?PHP if($option_category['color'] == "orange"){ echo "selected = 'selected'"; } ?>>Orange</option>
							</select>-->
				  		</td>
				  		<td class="left">
				  			<select style="width: 170px" name="product_option_category[<?php echo $optioncategory_row; ?>][size]">	
								<option value="">SELECT</option>
								<?php 
									foreach($option_categories_size as $intK => $option_categories_sizeDtls)
									{
										$strOptionName = $option_categories_sizeDtls['name'];
										$strOptionValue = $option_categories_sizeDtls['value'];
										$strSSelected = "";
										if(strtolower($option_category['size']) == strtolower($strOptionValue))
										{
											$strSSelected = "selected = 'selected'";
										}
									?>
										<option value="<?PHP echo $strOptionValue; ?>" <?PHP echo $strSSelected?>><?PHP echo $strOptionName; ?></option>
								<?php }	?>
							</select>
						</td>
               	 		<td class="right">
							<input type="text" name="product_option_category[<?php echo $optioncategory_row; ?>][qty]" value="<?php  echo $option_category['quantity']; ?>" size="2" /></td>
                		<td class="left"><a onclick="$('#optioncategory-row<?php echo $optioncategory_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
              		</tr>
            	</tbody>
            	<?php $optioncategory_row++; ?>
				<?php } ?>
			  <tfoot>
              <tr>
                <td colspan="3"></td>
                 <td class="left"><a onclick="addOptionCategory();" class="button">Add Options</a></td>
              </tr>
            </tfoot>
			</table>
		</div>
...
<script type="text/javascript"><!--
var OptionsCategory = '<?php echo $optioncategory_row; ?>';

function addOptionCategory() {
	html  = '<tbody id="optioncategory-row' + OptionsCategory + '">';
	html += '  <tr>'; 
    html += '<td class="left"><select name="product_option_category[' + OptionsCategory + '][color]"> <option value="">SELECT</option>';
	 <?php foreach ($option_categories_color as $option_categories_colorDtls) { 
	 	$strOptionName = $option_categories_colorDtls['name'];
		$strOptionValue = $option_categories_colorDtls['value'];
	?>
	/*html += '<option value="red">RED</option><option value="blue">BLUE</option><option value="yellow">Yellow</option><option value="white">White</option><option value="orange">Orange</option>';*/
	 html += '<option value="<?php echo $strOptionName; ?>"><?php echo $strOptionValue; ?></option>';
    <?php } ?>
    html += '</select></td>';
	html += '<td class="left"><select style="width: 170px" name="product_option_category['+ OptionsCategory +'][size]"><option value="">SELECT</option>';
	<?php foreach ($option_categories_size as $option_categories_sizeDtls) { 
	 	$strOptionName = $option_categories_sizeDtls['name'];
		$strOptionValue = $option_categories_sizeDtls['value'];
	?>
	 html += '<option value="<?php echo $strOptionName; ?>"><?php echo $strOptionValue; ?></option>';
    <?php } ?>		
	/*<option value="S">Small</option><option value="M">Medium</option><option value="L">Large</option><option value="XL">XL</option><option value="XXL">XXL</option>*/
	html += '</select></td>';
	html += ' <td class="right"><input type="text" name="product_option_category['+ OptionsCategory +'][qty]" value="" size="2" /></td>';
	html += '<td class="left"><a onclick="$(\'#optioncategory-row' + OptionsCategory + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
	$('#optioncategory tfoot').before(html);OptionsCategory++;
