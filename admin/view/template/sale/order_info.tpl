          ...
          <tbody>
            ...
            <tr>
              <td class="left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
			  		<?php if($product['color'] != ''){ echo '<br />- Color: '.$product['color']; } ?>
					<?php if($product['size'] != ''){ echo '<br />- Size: '.$product['size']; } ?>
					<?php if($product['greetingName'] != ''){ echo '<br />-'.$product['greetingName']; } ?>
					<?php if($product['wrappingName'] != ''){ echo '<br>-'.$product['wrappingName']; } ?>
