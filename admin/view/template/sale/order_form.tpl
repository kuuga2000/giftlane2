      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table class="form">
			...
			<tr>
				<td>No. Resi</td>
				<td><input type="text" name="no_resi" value="<?php echo $no_resi;?>" id="no_resi" style="width:189px"></td>
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
                ...
                <td class="left"><?php echo $order_product['name']; ?>
					<?php if($order_product['color'] != ''){ echo '<br />- Color: '.$order_product['color']; } ?>
					<?php if($order_product['size'] != ''){ echo '<br />- Size: '.$order_product['size']; } ?>
					<?php if($order_product['greetingName'] != ''){ echo '<br />-'.$order_product['greetingName']; } ?>
					<?php if($order_product['wrappingName'] != ''){ echo '<br>-'.$order_product['wrappingName']; } ?>
				  ...
				  <input  type="hidden" name="order_product[<?php echo $product_row; ?>][greetingId]" value="<?php echo $order_product['greetingId']; ?>"/>
				  <input  type="hidden" name="order_product[<?php echo $product_row; ?>][greetingName]" value="<?php echo $order_product['greetingName']; ?>"/>
				  <input  type="hidden" name="order_product[<?php echo $product_row; ?>][greetingPrice]" value="<?php echo $order_product['greetingPrice']; ?>"/>
				  <input  type="hidden" name="order_product[<?php echo $product_row; ?>][wrappingId]" value="<?php echo $order_product['wrappingId']; ?>"/>
				  <input  type="hidden" name="order_product[<?php echo $product_row; ?>][wrappingName]" value="<?php echo $order_product['wrappingName']; ?>"/>
				  <input  type="hidden" name="order_product[<?php echo $product_row; ?>][wrappingPrice]" value="<?php echo $order_product['wrappingPrice']; ?>"/>
            ...
            <tbody id="total">
              ...
              <tr>
                <td class="left"><?php echo $order_product['name']; ?><br />
                  ...
                  - <small><?php echo $option['name']; ?>: <?php echo $option['value']; ?></small><br />
                  <?php } ?>
				  	<?php if($order_product['greetingName'] != ''){ echo '-'.$order_product['greetingName']; } ?><br>
					<?php if($order_product['wrappingName'] != ''){ echo '-'.$order_product['wrappingName']; } ?><br>	
