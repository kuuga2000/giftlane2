...
<div id="header">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
        <ul>
         ...
         <!-- <li><a class="parent"><?php echo $text_voucher; ?></a>
		  ...
		  <li><a href="<?php echo $this->url->link('sale/contact/listemails', 'token=' . $this->session->data['token']);?>">List Emails</a></li>
 	 ...
 	 <li id="optioncategory"><a href="<?php echo $option_category; ?>" class="top">Option Category</a></li>
      <li id="reports"><a class="top"><?php echo $text_reports; ?></a>
		...
		<li id="optionpersonlize"><a href="<?php echo $option_personlize; ?>" class="top">Personalize</a></li>
      </li>
