...
$this->language->load('account/remember_me');
        $this->data['button_remember_me'] = $this->language->get('button_remember_me');
  ...
  if (isset($this->request->post['remember_me']) && $this->request->post['remember_me'] == '1') {
                setcookie("OCLoginReMCookies", $this->request->post['email'] . "||" . $this->request->post['password'], time() + 3600 * 24 * 365);
