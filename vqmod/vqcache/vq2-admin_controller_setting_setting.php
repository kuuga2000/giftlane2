...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['greetingPremium'])) {
			$this->data['error_greetingPremium'] = $this->error['greetingPremium'];
		} else {
			$this->data['error_greetingPremium'] = '';
		}	
		
		if (isset($this->error['wrappingPremium'])) {
			$this->data['error_wrappingPremium'] = $this->error['wrappingPremium'];
		} else {
			$this->data['error_wrappingPremium'] = '';
		}	
		...
		if (isset($this->request->post['config_tumbler'])) {
			$this->data['config_tumbler'] = $this->request->post['config_tumbler'];
		} else {
			$this->data['config_tumbler'] = $this->config->get('config_tumbler');
		}
		...
		if (isset($this->request->post['greetingPremium'])) {
			$this->data['greetingPremium'] = $this->request->post['greetingPremium'];
		} else {
			$this->data['greetingPremium'] = $this->config->get('greetingPremium');		
		}
		
		if (isset($this->request->post['wrappingPremium'])) {
			$this->data['wrappingPremium'] = $this->request->post['wrappingPremium'];
		} else {
			$this->data['wrappingPremium'] = $this->config->get('wrappingPremium');		
		}
 ...
 //product display settings		
		...
		//end of product display options
	...
	protected function validate() {
		...
		if (isset($this->request->post['greetingPremium']) && !is_numeric($this->request->post['greetingPremium'])) {
			$this->error['greetingPremium'] = 'Please enter valid amount';
		}
		
		if (isset($this->request->post['wrappingPremium']) && !is_numeric($this->request->post['wrappingPremium'])) {
			$this->error['wrappingPremium'] = 'Please enter valid amount';
		}
