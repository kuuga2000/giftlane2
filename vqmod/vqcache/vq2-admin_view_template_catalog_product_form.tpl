      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tab_personalize_question">
			...
			<tr>
				...
				<td class="left"><select name="interest"  style="width: 170px"><?php foreach($personalize_interest AS $interest) {  ?> <option value="<?php echo $interest['answer'] ?>" <?php if(isset($answers[0]['interests']) && $answers[0]['interests']== $interest['answer']){?> selected="selected" <?php } ?>><?php echo $interest['answer']; ?></option> <?php } ?></select> </td>
			</tr>
			<tr>
