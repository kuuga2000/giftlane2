      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
			...
			<td>Facebook Url:</td>
              <td><input type="text" name="config_fb" value="<?php echo $config_fb; ?>" size="45"/>
               </td>
            </tr>
             <tr>
              <td>Twitter Url:</td>
              <td><input type="text" name="config_twitter" value="<?php echo $config_twitter; ?>" size="45" />
               </td>
            </tr>
             <tr>
              <td>Tumbler Url:</td>
              <td><input type="text" name="config_tumbler" value="<?php echo $config_tumbler; ?>" size="45"/>
               </td>
            </tr>
             <tr>
              <td>Pinterest Url:</td>
              <td><input type="text" name="config_pinterest" value="<?php echo $config_pinterest; ?>" size="45"/>
               </td>
            </tr>
			<tr>
              <td>Instagram Url:</td>
              <td><input type="text" name="config_instagram" value="<?php echo $config_instagram; ?>" size="45" />
               </td>
            </tr>
			 <tr>
...
<table class="form">
			<tr>
              <td>Display rewards points on product page?</td>
			...
			<tr>
              <td>Display weight on product page?</td>
			...
			<tr>
              <td>Display sku in product listing?</td>
			...
			<tr>
              <td>Display sku in product page?</td>
			...
			<tr>
              <td>Display model in product listing?</td>
			...
			<tr>
              <td>Display model in product page?</td>
			...
			<tr>
              <td>Display manufacturer in product listing?</td>
			...
			<tr>
              <td>Display manufacturer in product page?</td>
			...
			<tr>
              <td>Display location in product listing?</td>
              ...
              <td>Display location in product page?</td>
			...
			<tr>
              <td>Display upc in product listing?</td>
              ...
              <td>Display upc in product page?</td>
			...
			<tr>
              <td>Display stock status/qty in product listing?</td>
		 ...
		 <h2>Premium prices</h2>	
      		<table>
				<tr>
					<td>Greeting Premium price</td>
					<td><input  type="text" name="greetingPremium" value="<?php echo $greetingPremium; ?>"/><br><?php if($error_greetingPremium !=''){ echo '<div class="warning">'.$error_greetingPremium.'</div>'; } ?></td>
				</tr>
				<tr>
					<td>Wrapping Premium price</td>
					<td><input  type="text" name="wrappingPremium" value="<?php echo $wrappingPremium; ?>"/><br><?php if($error_wrappingPremium != ''){ echo '<div class="warning">'.$error_wrappingPremium.'</div>'; } ?></td>
				</tr>
			</table>
	    </div>
        <div id="tab-image">
