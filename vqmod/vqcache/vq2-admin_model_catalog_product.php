...
class ModelCatalogProduct extends Model {
	...
	public function editProduct($product_id, $data) {	
		...
		$addQuery = "UPDATE " . DB_PREFIX . "product_personalize_gift SET events = '".$events."', receipients= '".$receipients."', personality = '".$personalityStr."', gender = '".$genders."', min_age = ".(int)$data['startAge'].", max_age = ".(int)$data['endAge'].", interests = '".$data['interest']."', min_tech_savvy = ".(int)$data['startTecksavy'].", max_tech_savvy = ".(int)$data['endTecksavy'].", min_warddrobe_color = ".(int)$data['startWarddrobColor']." , max_warddrobe_color = ".(int)$data['endWarddrobColor'].", min_creativity_level = ".(int)$data['startCreativity'].", max_creativity_level = ".(int)$data['endCreativity']." , modified = now(), created = now() WHERE product_id = ".(int)$product_id."  ";
